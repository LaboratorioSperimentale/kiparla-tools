...
if __name__ == "__main__":
	...
	transcripts = process_all_transcripts("/Users/martinasimonotti/asr-assisted-transcription/asr-assisted-transcription/data/csv_puliti", "/Users/martinasimonotti/asr-assisted-transcription/asr-assisted-transcription/data/output") 
	...
	for file in pathlib.Path(f"/Users/martinasimonotti/asr-assisted-transcription/asr-assisted-transcription/data/output").glob("*.tsv"):
		serialize.csv2eaf(file, f"data/audio/{file.stem}.wav", f"/Users/martinasimonotti/asr-assisted-transcription/asr-assisted-transcription/data/output/{file.stem}.eaf")

	serialize.print_full_statistics(transcripts, "/Users/martinasimonotti/asr-assisted-transcription/asr-assisted-transcription/data/output/statistics.csv")
